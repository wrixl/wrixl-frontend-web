...
class SignalFeed extends StatelessWidget {
  ...
  void _showDetailModal(BuildContext context, _SignalItem item) {
    final tagColor = _getSentimentColor(context, item.sentiment);
        ...
        children: [
          ...
          Wrap(
            ...
            children: item.tags.map((tag) {
              final c = _getTagColor(context, tag);
              return Chip(
                label: Text(tag),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Dynamically sized scrollable feed
                Expanded(
  ...
  Widget _buildSentimentBadge(String sentiment) {
    final color = _getSentimentColor(null, sentiment);
    return Container(
  ...
  Color _getSentimentColor(BuildContext? ctx, String sentiment) {
    switch (sentiment) {
      case "Bullish":
