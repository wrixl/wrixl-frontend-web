...
class MarketSignalsSmartNewsStripWidget extends StatefulWidget {
  ...
  @override
  State<MarketSignalsSmartNewsStripWidget> createState() =>
...
class _MarketSignalsSmartNewsStripWidgetState
  ...
  Map<String, dynamic> getSentimentBadge(
      ColorScheme scheme, String sentiment) {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text("Smart Feed", style: theme.textTheme.titleMedium),
                  IconButton(
                ...
                child: ScrollConfiguration(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return InkWell(
                        onTap: () {
                          // ← replace AlertDialog with your reusable modal
                          showNewReusableModal(
                            context,
                            title: "News Details",
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 12),
                                Text(
                                  "Full article summary would appear here. You can even add images or links.",
                                  style: theme.textTheme.bodySmall,
                                ),
                              ],
                            ),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Icon(getNewsIcon(item.category),
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        (badge['color'] as Color).withOpacity(0.9),
